...
object SemillaActos {
    val actos = listOf(
        ...
        ActoEntity(id = 2, nombre = "Subiendo al escenario", orden = 2, desbloqueado = true, completado = false),
        ActoEntity(id = 3, nombre = "Gran Función", orden = 3, desbloqueado = true, completado = false)
    )
}
